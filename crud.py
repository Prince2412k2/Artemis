...
# ---- Workspace ----
def create_workspace(session: Session, name: str, user_id: int):
...
def get_workspaces(session: Session, user_id: int):
...
# ---- Project ----
def create_project(session: Session, name: str, workspace_id: int):
...
def get_projects(session: Session, workspace_id: int):
...
# ---- Run ----
def create_run(session: Session, name: str, project_id: int):
...
def get_runs(session: Session, project_id: int):
